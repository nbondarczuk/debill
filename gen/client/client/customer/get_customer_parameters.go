...
// WithCustomer adds the customer to the get customer params
func (o *GetCustomerParams) WithCustomer(customer string) *GetCustomerParams {
	o.SetCustomer(customer)
	return o
}

// SetCustomer adds the customer to the get customer params
func (o *GetCustomerParams) SetCustomer(customer string) {
	o.Customer = customer
}
