...
// WithAccount adds the account to the get account params
func (o *GetAccountParams) WithAccount(account string) *GetAccountParams {
	o.SetAccount(account)
	return o
}

// SetAccount adds the account to the get account params
func (o *GetAccountParams) SetAccount(account string) {
	o.Account = account
}
