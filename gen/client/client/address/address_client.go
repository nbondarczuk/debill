...
// New creates a new address API client with basic auth credentials.
...
// New creates a new address API client with a bearer token for authentication.
// It takes the following parameters:
// - host: http host (github.com).
// - basePath: any base path for the API client ("/v1", "/v3").
// - scheme: http scheme ("http", "https").
...
type ClientService interface {
	GetAddress(params *GetAddressParams, opts ...ClientOption) (*GetAddressOK, error)
...
*/
func (a *Client) GetAddress(params *GetAddressParams, opts ...ClientOption) (*GetAddressOK, error) {
