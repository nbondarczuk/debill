...
// WithAddress adds the address to the get address params
func (o *GetAddressParams) WithAddress(address string) *GetAddressParams {
	o.SetAddress(address)
	return o
}

// SetAddress adds the address to the get address params
func (o *GetAddressParams) SetAddress(address string) {
	o.Address = address
}
